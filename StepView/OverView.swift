    ...
    var body: some View {
        ...
        ZStack {
            ...
            Image(getImageName(isR: true, mode_R: stepData.stepDetails[index].R_mode, mode_L: stepData.stepDetails[index].L_mode))
                ...
                .position(CGPoint(x: stepData.stepDetails[index].R_x/5-(deviceWidth/10)+10,y: stepData.stepDetails[index].R_y/5-30+5))
            ...
            Image(getImageName(isR: false, mode_R: stepData.stepDetails[index].R_mode, mode_L: stepData.stepDetails[index].L_mode))
                ...
                .position(CGPoint(x: stepData.stepDetails[index].L_x/5-(deviceWidth/10)+10,y: stepData.stepDetails[index].L_y/5-30+5))
                .frame(width: 15,height: 15)
        }
